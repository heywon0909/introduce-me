...
import { CareerDescription } from '@components/page/career/CareerDescription'

const bg = [
    'linear-gradient(180deg, #0b0d0d 0%, #0f1313 30%, #0b2b4b 100%, #14243b 100%)',
    'linear-gradient(180deg, #051c33 0%, #03355b 30%, #194272 60%, #1e6292 100%)',
    'linear-gradient(180deg, #1586ba 0%, #0f659f 30%, #135980 50%, #005d61 100%)',
    'linear-gradient(180deg, #3b7e8d 0%, #0f6389 30%, #04395e 60%, #032130 100%)',
]
export default function Resume() {
    return (
        <>
            <S.Section>
                <SelfIntroduce bg={bg[0]} />
                <Wave bg={'rgb(6 28 51)'} fill={'#0b2b4b'} />
                <CareerDescription
                    bg={bg[1]}
                    company="알스솔루션"
                    description={
                ...
                />
                <Wave bg={'rgb(16 132 189)'} fill={'#1f6190'} />
                <CareerDescription
                    bg={bg[2]}
                    company="티맥스와플"
                    description={
                ...
                <Wave bg={'rgb(58 125 139)'} fill={'#015d64'} />
                <CareerDescription
                    bg={bg[3]}
                    company="이씨오"

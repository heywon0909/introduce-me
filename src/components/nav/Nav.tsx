    ...
    >
      <S.Nav>
        {hover && (
          <>
            <S.NavWrapper>
              <S.NavImg src={"/assets/image/woman.png"} alt="info" />
              <S.NavText>Info</S.NavText>
            </S.NavWrapper>
            <S.NavWrapper>
              <S.NavImg src={"/assets/image/pencil.png"} alt="skills" />
              <S.NavText>Skills</S.NavText>
            </S.NavWrapper>
            <S.NavWrapper>
              <S.NavImg src={"/assets/image/resume.png"} alt="info" />
              <S.NavText>Resume</S.NavText>
            </S.NavWrapper>
            <S.NavWrapper>
              <S.NavImg src={"/assets/image/idea.png"} alt="info" />
